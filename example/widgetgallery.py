...
from PyQt5.QtGui import (QCursor, QDesktopServices, QGuiApplication, QIcon,
                           QKeySequence, QStandardItem,
                           QStandardItemModel)
from PyQt5.QtCore import (QDateTime, QDir, QLibraryInfo,
                            QSysInfo, QTimer, Qt, qVersion, pyqtSlot)
